const contractAddress = "0x5b0891B8C54848C70c2b47F6aFbCBFB998cb31FC"; // Replace with your own contract address
const chain = 'ethereum'; // rinkeby, polygon, or ethereum

const welcome_h1 = "Welcome to the CryptoSwarm AI NFT Project";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'CryptoSwarm AI is a collective Super Intelligence for predicting crypto assets using hundreds of human forecasters and the power of Swarm AI. For more information, visit our <a href="https://www.cryptoswarm.ai">website</a>. For help minting, see our <a href="https://www.cryptoswarm.ai/help">help page</a> or talk to us on our <a href="https://discord.com/invite/js4g9Xqa3K">discord</a>.<br><br>🎉 Join our <a href="https://twitter.com/i/spaces/1nAKErXRRbAGL">live Twitter space</a> for the mint party 🎉';
...
const p_presale_coming_soon = 'We are working hard to launch the NFT Collection. Join our live Twitter space for the mint party 🎉 ';
...
const p_public_mint = 'Public minting is now open! 🎉\n\nBy minting, you agree to the terms of use of this service';
