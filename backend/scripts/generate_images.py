    ...
    for i, (image, priority) in enumerate(collection):
        ...
        data = {
            ...
            "description": "CryptoSwarm AI is a collective Super Intelligence for predicting crypto assets using "
                           "hundreds of human forecasters and the power of Swarm AI. \n"
                           "Go to https://www.cryptoswarm.ai/ for more information, and join our Discord: "
                           "https://discord.gg/4g2ccHE8cv \n"
                           "The Terms of Service of this NFT can be found here: "
                           "https://ipfs.io/ipfs/bafkreihsq3amdl5cmorc2sqc73bor2kbdxprwmnr5bgxe7m2rdy2tdobau",
            "external_url": "https://www.cryptoswarm.ai/",
            "image": "ipfs://NewUriToReplace/{}.png".format(i),
            "terms_of_service": "https://ipfs.io/ipfs/bafkreihsq3amdl5cmorc2sqc73bor2kbdxprwmnr5bgxe7m2rdy2tdobau",
            "attributes": [
                {
